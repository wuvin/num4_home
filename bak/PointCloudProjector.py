...
class PointCloudProjector(Node):
    def __init__(self):
        ...
        PROJ_TOPIC  = '/pointcloud_projection'
        DIAG_TOPIC  = '/pc2/diag'
        ...
        # Declare publisher for the projection
    ...
    def project_points_onto_image(self, points, image):
        ...
        # Get visible points
        is_visible = (points[:,2] > 0)  # 3rd axis after transform
        ...
        for ii, (u, v) in enumerate(uv):
            ...
            depth = (depths[ii] - mindepth) / (maxdepth - mindepth)
